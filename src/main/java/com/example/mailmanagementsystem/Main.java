...
public class Main {
    public static void main(String[] args) {
        ...
        Package package1 = new Package.Builder().parcelID(1).sender(sender).recipient(recipient).destinationAddress(recipient.getAddress()).status("sent").weight(10.1).height(10.2).width(12.2).length(5.5).build();
