package com.example.mailmanagementsystem.utils;
...
public class ViewSwitcher {
    ...
    public static void switchScene(ActionEvent event, String viewName, String cssName, int width, int height, Object thisClass) throws IOException {
        try {
            String viewPath = "/com/example/mailmanagementsystem/views/" + viewName +".fxml";
            String cssPath = "/com/example/mailmanagementsystem/css/"+ cssName + ".css";
